...
import { Upload, Button, Message, Modal, Grid, Slider } from '@adminium/arco-design';
import { IconMinus, IconPlus, IconRotateLeft, IconUpload } from '@adminium/arco-design/icon';
