...
&nbsp;&nbsp;Typography <br/>
<span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'@adminium/arco-design'</span><span class="token punctuation">;</span><br/>
`;
const demo2Html = `
...
<span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'@adminium/arco-design'</span><span class="token punctuation">;</span><br/>
<span class="token keyword">import</span> <span class="token punctuation">{</span> IconCamera<span class="token punctuation">,</span> IconPlus <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'@adminium/arco-design/icon'</span><span class="token punctuation">;</span><br/>
`;
