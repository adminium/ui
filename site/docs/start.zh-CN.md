...
* 开发环境: https://unpkg.com/@adminium/ui@latest/dist/arco.development.js
* 生产环境: https://unpkg.com/@adminium/ui@latest/dist/arco.min.js
  * 图标: https://unpkg.com/@adminium/ui@latest/dist/arco-icon.min.js
...
`@adminium/ui` 的组件默认支持 `tree shaking`, 使用 `import { Button } from '@adminium/ui';` 方式引入即可按需加载。
